...
exports.registerFluxBuilderFeature = registerFluxBuilderFeature;
const config_1 = require("../../core/config");
function registerFluxBuilderFeature(bot) {
    ...
    bot.command("fluxwell", async (ctx) => {
        ...
        const args = ((_b = (_a = ctx.message) === null || _a === void 0 ? void 0 : _a.text) !== null && _b !== void 0 ? _b : "").split(/\s+/).slice(1);
        const action = ((_c = args[0]) !== null && _c !== void 0 ? _c : "").toLowerCase();
        ...
        const { data: region, error: regErr } = await supabase
            ...
            .eq("telegram_chat_id", (_d = ctx.chat) === null || _d === void 0 ? void 0 : _d.id)
            .maybeSingle();
        if (regErr || !region) {
