...
// This is a minimal skeleton for the inline admin builder UI.
// It doesn't cover all flows yet, but gives you a starting point.

export function registerWorldAdminFeature(bot: Bot<MyContext>) {
  // Entry point: only master can open admin menu
